...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reply_kb = owner_keyboard if user_id == OWNER_IDS else allowed_user_keyboard
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if message_text == "ping":
        ...
        return
    elif message_text == "userlist" and user_id == OWNER_IDS:
        await userlist(update, context)
        return
    elif message_text == "on" and user_id == OWNER_IDS:
        await update.message.reply_text("✅ Bot is now *ON*. All systems go! 🚀", parse_mode="Markdown")
        return
    elif message_text == "off" and user_id == OWNER_IDS:
